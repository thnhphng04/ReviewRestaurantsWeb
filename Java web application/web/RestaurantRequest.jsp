...
<head>
    ...
    <script>
        ...
        function showDenyPopup(restaurantId) {
...
<!--                <li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="button-container">
                                                    <a href="AcceptRestaurantRequest?id=${c.restaurantId}">
                                                        <button type="button" data-button="accept" onclick="accept()">Chấp nhận</button>
                                                    </a>
                                                    <button type="button" data-button="deny" onclick="showDenyPopup('${c.restaurantId}')">Từ chối</button>
                                                </div>
    ...
    <div id="deny-popup-dialog">
        ...
        <p style="">Xác nhận rằng bạn từ chối nhà hàng với lý do sau</p>
        <form action="AcceptRestaurantRequest" method="POST">
