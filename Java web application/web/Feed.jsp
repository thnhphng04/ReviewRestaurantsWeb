        ...
        <main>
            <div class="container">
                <div class="left">
                    ...
                    <!-- Sidebar -->
                    <div class="sidebar">
                        <a class="menu-item active" href="Feed">
                ...
                <div class="middle">
                    <c:if test="${sessionScope.AccDetail!=null}">
                        <a data-toggle="modal" data-target="#exampleModal">
                            <form class="create-post">
                                ...
                                <input type="text" placeholder="Bạn muốn review?" id="create-post">
                    ...
                    <c:if test="${sessionScope.AccDetail!=null && notLoadMore==null}">
                    ...
                    <form id="postForm" action="createPost" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" style="display: flex; align-items: center; justify-content: flex-start">
                                ...
                                <input type="number" class="form-control" id="rating" value="2.5" name="rating" min="0" max="5" step="0.1" required readonly style="border: none; width: 10%; font-size: 22px;">
