...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <div class="container">
                ...
                <div class="middle">
                    ...
                    <div class="stories">
                        <a class="story" href="Explore?typeOfFood=1" style="text-decoration: none">

                            <p class="name">Đồ ăn</p>
                        </a>
                        <a class="story" href="Explore?typeOfFood=2" style="text-decoration: none">

                            <p class="name">Đồ uống</p>
                        </a>
                        <a class="story" href="Explore?typeOfMeal=4" style="text-decoration: none">

                            <p class="name">Ăn vặt</p>
                        </a>
                        <a class="story" href="Explore?typeOfMeal=1" style="text-decoration: none">

                            <p class="name">Ăn sáng</p>
                        </a>
                        <a class="story" href="Explore?typeOfMeal=2" style="text-decoration: none">

                            <p class="name">Ăn trưa</p>
                        </a>
                        <a class="story" href="Explore?typeOfMeal=3" style="text-decoration: none">

                            <p class="name">Ăn tối</p>
                        </a>
                    </div>
                    <!-- End of Stories -->
                    ...
                    <div class="explore" id="explore">
                        ...
                        <c:forEach items="${requestScope.postMap}" var="p">
                            <c:if test="${p.value.status==1}">
                                <div class="feed">
                                    <a href="Profile?accountId=${p.key.accountId}&page=1" style="text-decoration: none; color: black">
                                        <div class="head">
                                    ...
                                    <a href="PostPage?postId=${p.value.postId}" style="text-decoration: none; color: black">
                                        <div class="caption">
                                            <p><b>${p.value.title}</b> 
                                        </div>
                                    </a> 
                    ...
                    <c:if test="${notLoadMore==null}">
                        <button class="btn btn-primary" onclick="LoadMore()">Hiển thị thêm</button>
                    </c:if>
                </div>
        ...
        <script type="text/javascript">
            function LoadMore() {
                var amount = document.getElementsByClassName("feed").length;
