...
<!--                <li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="button-container">
                                                    <a href="AcceptPostRequest?id=${c.postId}">
                                                        <button type="button" data-button="accept" onclick="accept()">Chấp nhận</button>
                                                    </a>
                                                    <button type="button" data-button="deny" onclick="showDenyPopup('${c.postId}')">Từ chối</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach> 
    ...
    <div id="deny-popup" style="display: none;">
        <div id="deny-popup-dialog">
            ...
            <p style="">Xác nhận bạn từ chói với lý do sau</p>
