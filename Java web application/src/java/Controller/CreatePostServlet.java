...
public class CreatePostServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, String a)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PostServlet at " + serviceRating + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        pd.insertPort(accountId, title, text, rating, restaurantId, serviceRating, priceRating, spaceRating, tasteRating, hygieneRating);
        ...
        String message = "Bạn đã tạo bài viết thành công!";
