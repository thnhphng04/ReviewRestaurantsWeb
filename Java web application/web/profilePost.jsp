<%-- 
    ...
    Created on : Jun 9, 2024, 4:00:32 PM
    Author     : DELL
--%>
                    ...
                    <div class="middle">
                        ...
                        <div class="feeds">
                            <c:forEach items="${requestScope.postMap}" var="p">
                                ...
                                <c:if test="${p.value.status==3 && requestScope.account.accountId==sessionScope.AccDetail.accountId}">
                                    <div class="feed">
                                        <div class="head">
                                            <div class="user">
                                                <div class="profile-photo">
                                            ...
                                            <p style="color:red">Bài viết này không được duyệt vì: ${p.value.reasonDeny}</p>
                                        </div>
                                        <small>${p.value.getFormattedDate()}</small>
                                        <a href="PostPage?postId=${p.value.postId}">
                                            <div class="photo">
                                ...
                                <c:if test="${p.value.status==6 && requestScope.account.accountId==sessionScope.AccDetail.accountId}">
                                    <div class="feed">
                                        <div class="head">
                                            <div class="user">
                                                <div class="profile-photo">
                                            ...
                                            <p style="color:darkred">Bài viết của bạn đã bị báo cáo và xóa vì: ${p.value.reasonDeny}</p>
                                        </div>
                                        <small>${p.value.getFormattedDate()}</small>
                                        <a href="PostPage?postId=${p.value.postId}">
                                            <div class="photo">
                                ...
                                <c:if test="${p.value.status==2 && requestScope.account.accountId==sessionScope.AccDetail.accountId}">
                                    <div class="feed">
                                        <div class="head">
                                            <div class="user">
                                                <div class="profile-photo">
                                ...
                                <c:if test="${p.value.status==5 && requestScope.account.accountId==sessionScope.AccDetail.accountId}">
                                    <div class="feed">
                                        <div class="head">
                                            <div class="user">
                                                <div class="profile-photo">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', (event) => {
                ...
                document.querySelector('.modal-header .close').addEventListener('click', () => {
                    window.location.href = 'Profile?accountId=${requestScope.account.accountId}&page=1';
                });
            });
