...
public class DeleteComment extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        cd.hideComment(commentId);
        
        
        String message = "Bạn đã xóa bình luận thành công!";

        response.sendRedirect("PostPage?postId="+ postId +"&message=" + URLEncoder.encode(message, "UTF-8"));
    } 
