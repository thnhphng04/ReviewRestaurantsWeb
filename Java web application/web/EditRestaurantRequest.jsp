...
<head>
    ...
    <title>Edit restaurant request</title>
                        ...
                        <div class="box-body">
                            <table width="100%" class="table table-hover table-striped" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th>ID nhà hàng</th>
                                        <th>ID của người đăng</th>
                                        <th>Tên</th>
                                        <th>Địa chỉ</th>
                                        <th>Xem địa điểm đã chỉnh sửa</th>
                                        <th>Xem địa điểm ban đầu</th>
                                        <th>...</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <c:forEach items="${requestScope.editRestaurants}" var="c">
                                        <tr>
                                            ...
                                            <td><a class="a" href="RestaurantPage?restaurantId=${c.editOf}">Xem </a></td>
                                            <td class="text-end">
                                                <div class="button-container">
                                                    <a href="acceptEditRestaurant?edittedRestaurantId=${c.restaurantId}&editOfRestaurantId=${c.editOf}&action=1"><button type="button" data-button="accept" onclick="accept()">Duyệt</button></a>
                                                    <a href="acceptEditRestaurant?edittedRestaurantId=${c.restaurantId}&editOfRestaurantId=${c.editOf}&action=0"><button type="button" data-button="deny" onclick="accept()">Từ chối</button></a>
                                                    <div>
                                                        </td>
                                                        </tr>
                                                    </c:forEach> 
