 ...
 * @author DELL
 */
@WebServlet(name = "LoadMoreFeedServlet", urlPatterns = {"/LoadMoreFeed"})
public class LoadMoreFeedServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Post> posts = pd.getNextFeedPosts(sessionAccount.getAccountId() ,Integer.parseInt(total), getServletContext());
